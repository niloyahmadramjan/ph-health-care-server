...
export const seedSuperAdmin = async () => {
    try {
        ...
        const name = config.super_admin_email
...
export const seedTesterDoctor = async () => {
    try {
        ...
        const name = config.doctor_email
        const email = config.doctor_email
        const password = config.doctor_pass
